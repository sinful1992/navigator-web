-- Fix the status value in the trial subscription function
-- Update to use 'trial' instead of 'trialing'
...
BEGIN
    ...
    -- Insert the trial subscription with valid status
    INSERT INTO public.user_subscriptions (
        ...
        target_user_id,
        'trial',
        'trial',  -- Changed from 'trialing' to 'trial'
        NOW(),
        trial_end_date,
        NOW(),
        trial_end_date,
